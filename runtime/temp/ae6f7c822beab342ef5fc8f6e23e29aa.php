<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:56:"E:\project\shop03/application/admin\view\auth\group.html";i:1522308934;s:59:"E:\project\shop03/application/admin\view\public\header.html";i:1522829166;s:59:"E:\project\shop03/application/admin\view\public\dialog.html";i:1522308934;s:58:"E:\project\shop03/application/admin\view\public\color.html";i:1522308934;s:59:"E:\project\shop03/application/admin\view\public\footer.html";i:1522308934;}*/ ?>
 <!-- 头部 -->
			...
			<div class="tips_msg none"><span class="tips">保存成功</span><span class="close_tips"></span></div>
				...
				<div class="edit_box">
					...
					<div class="edit_content">
							 <form class="group-form"  action="<?php echo url('addToGroup'); ?>" method="post">
                ...
                <label class="checkbox">
                    <input class="auth_groups" type="checkbox" name="group[]" value="<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?>
                </label>
            <?php endforeach; endif; else: echo "" ;endif; ?>
