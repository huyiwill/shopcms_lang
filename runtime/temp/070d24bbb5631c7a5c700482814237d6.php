<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:58:"E:\project\shop03/application/admin\view\models\index.html";i:1522308934;s:59:"E:\project\shop03/application/admin\view\public\header.html";i:1522829166;s:59:"E:\project\shop03/application/admin\view\public\dialog.html";i:1522308934;s:58:"E:\project\shop03/application/admin\view\public\color.html";i:1522308934;s:59:"E:\project\shop03/application/admin\view\public\footer.html";i:1522308934;}*/ ?>
 <!-- 头部 -->
					    ...
					    <tr>
				         ...
				         <?php if(is_array($res['list']) || $res['list'] instanceof \think\Collection || $res['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $res['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr class="even gradeC">  
					           ...
					           <td><?php echo $vo['title']; ?></td><td> <a href="<?php echo url('Attributes/index?model_id='.$vo['id']); ?>" >商品属性</a></td><td> <a href="<?php echo url('specs/index?model_id='.$vo['id']); ?>" >规格属性</a></td>
