<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:55:"E:\project\shop03/application/admin\view\sku\index.html";i:1522308934;s:59:"E:\project\shop03/application/admin\view\public\header.html";i:1522829166;s:59:"E:\project\shop03/application/admin\view\public\dialog.html";i:1522308934;s:58:"E:\project\shop03/application/admin\view\public\color.html";i:1522308934;s:59:"E:\project\shop03/application/admin\view\public\footer.html";i:1522308934;}*/ ?>
 <!-- 头部 -->
			...
			<div class="content">
                ...
                <div class="search">
					<form class="search-form"  action="<?php echo url(); ?>" method="post">
					  <div class="group">
					       商品id：<input type="text" name="goods_id" class="search_ipt" value="<?php echo input('goods_id'); ?>"/>
					...
					<table class="list_table">
				        ...
				        <?php if(is_array($res['list']) || $res['list'] instanceof \think\Collection || $res['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $res['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr class="even gradeC">
								...
								<td><a title="编辑" href="<?php echo U('index?pid='.$vo['id']); ?>"><?php echo get_goods($vo['goods_id'],"title"); ?></a></td>
