<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:57:"E:\project\shop03/application/admin\view\goods\index.html";i:1522308934;s:59:"E:\project\shop03/application/admin\view\public\header.html";i:1522829166;s:59:"E:\project\shop03/application/admin\view\public\dialog.html";i:1522308934;s:58:"E:\project\shop03/application/admin\view\public\color.html";i:1522308934;s:59:"E:\project\shop03/application/admin\view\public\footer.html";i:1522308934;}*/ ?>
<!-- 头部 -->
					...
					<table class="goods">
				       ...
				       <?php if(is_array($res['list']) || $res['list'] instanceof \think\Collection || $res['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $res['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
								...
								<td><img src="<?php echo get_cover_path($vo['cover_id']); ?>" class="thumb"> </td>
								<td class="tit"><a href="<?php echo U('goods/edit?id='.$vo['id']); ?>"><?php echo $vo['title']; ?></a> </td>
								...
								<td class="list_opr">
								    <span class="opr_box">
									    ...
									    <a href="<?php echo site_url(); ?>/index.php/index/goods/detail/id/<?php echo $vo['id']; ?>" class="preview" target="_blank">预览</a>
									</span>          
								</td>
                           </tr>
					    <?php endforeach; endif; else: echo "" ;endif; ?>
...
var sid="<?php echo input('pid'); ?>";var obj=$("span#"+sid);$(obj).parents("li").eq(0).addClass("active");
</script> 
