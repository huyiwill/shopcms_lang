<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"E:\project\shop03/application/install\view\index\index.html";i:1522308934;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<body>
		<div class="border">
			...
			<div class="rule_title">yershop V3.0(第一款thinkphp开源商城系统)<span>安装协议</span></div>
			<div class="rules">
				<br/>
				<div>版权所有 (c) 2014，yershop保留所有权利。</div>
				<div>感谢您选择yershop，yershop诞生于2014年9月，是第一款thinkphp开源商城系统，希望我们的努力能为您提供一个简单、强大的站点解决方案。</div>
		    ...
		    <div class="btn_group">
		    	...
		    	<div class="agree">   <a  href="<?php echo url('Install/step1'); ?>">同意安装协议</a></div>	
